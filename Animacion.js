...
var material= new THREE.MeshBasicMaterial({color: 0xBB0100});
...
function setup(){
  ...
  torreMalla = new THREE.Mesh(torreForma, oro);
  torreMalla1 = new THREE.Mesh(torreForma, plata);
  torreMalla2 = new THREE.Mesh(torreForma, plata);
  torreMalla3 = new THREE.Mesh(torreForma, oro);
  ...
  //var material= new THREE.MeshNormalMaterial();
  reyMalla = new THREE.Mesh(reyForma, oro);
  reyMalla1 = new THREE.Mesh(reyForma, plata);
  ...
  //var material= new THREE.MeshNormalMaterial();
  reinaMalla = new THREE.Mesh(reinaForma, oro);
  reinaMalla1 = new THREE.Mesh(reinaForma, plata);
 ...
 var base1Forma = new THREE.CylinderGeometry(5,5,1,20,1,false);
  ...
  //var material= new THREE.MeshNormalMaterial();
  alfilMalla = new THREE.Mesh(alfilForma, oro);
  alfilMalla1 = new THREE.Mesh(alfilForma, plata);
  alfilMalla2 = new THREE.Mesh(alfilForma, oro);
  alfilMalla3 = new THREE.Mesh(alfilForma, plata);
  ...
  peonMalla = new THREE.Mesh(peonForma, oro);
  peonMalla1 = new THREE.Mesh(peonForma, oro);
  peonMalla2 = new THREE.Mesh(peonForma, oro);
  peonMalla3 = new THREE.Mesh(peonForma, oro);
  peonMalla4 = new THREE.Mesh(peonForma, oro);
  peonMalla5 = new THREE.Mesh(peonForma, oro);
  peonMalla6 = new THREE.Mesh(peonForma, oro);
  peonMalla7 = new THREE.Mesh(peonForma, oro);
  peonMalla8 = new THREE.Mesh(peonForma, plata);
  peonMalla9 = new THREE.Mesh(peonForma, plata);
  peonMalla10 = new THREE.Mesh(peonForma, plata);
  peonMalla11 = new THREE.Mesh(peonForma, plata);
  peonMalla12 = new THREE.Mesh(peonForma, plata);
  peonMalla13 = new THREE.Mesh(peonForma, plata);
  peonMalla14 = new THREE.Mesh(peonForma, plata);
  peonMalla15 = new THREE.Mesh(peonForma, plata);
